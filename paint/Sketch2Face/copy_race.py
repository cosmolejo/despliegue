...
import os
from paint.Sketch2Face.data.base_dataset import BaseDataset, get_params, get_transform, normalize, get_transform_sketch, get_transform_race
from paint.Sketch2Face.util.Dictx import DictX
from collections import OrderedDict
from torch.autograd import Variable
#from options.test_options import TestOptions
from paint.Sketch2Face.data.data_loader import CreateDataLoader
from paint.Sketch2Face.models.models import create_model
import paint.Sketch2Face.util.util as util
import torch
import time
import pathlib
...
class FaceGenerator:
    def __init__(self):
        print('asdasdasdasdas ',pathlib.Path().absolute())
        self.opt = DictX({})
        ...
        self.opt.checkpoints_dir = './paint/Sketch2Face/checkpoints'
    ...
    def generate_face(self,sketch, race):
